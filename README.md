...
The terminal UI features keyboard controls inspired by btop:
- q — Quit
- h — Toggle help overlay
- space — Toggle selection on the focused tree node
- a — Select all
- A — Deselect all

This provides a quick, keyboard-ready workflow similar to btop.
